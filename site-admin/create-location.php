                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card-box" style="margin-top:20px">
                            <div style="padding: 20px">
                                <h4 class="m-t-0 header-title">Create Location</h4>
                                ...
                                <form name="locationform" id="locationform" method="post" action="">
                                    ...
                                    <label>Choose Location Image</label><br>
                                    ...
                                    <div class="phone-nums" style="padding: 5px; background: #eee">
                                        ...
                                        for($i=0; $i<count($phonAes); $i++){
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input style="background: #fff" type="text" class="form-control" name="phone-class[]" placeholder="Phone Number" value="'.$phonAes[$i]["phoneClass"].'">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label>&nbsp;</label><br>
                                    ...
                                    <br><br>
                                    <button style="float: right" class="btn btn-default btn-fill">Save Location</button>
                                    <div class="clearfix"></div>
                                    <br>
                                </form>
                                ...
                                <?php
                                    ...
                                    <div class="form-group col-md-4" style="padding-left: 0">
                                        <label for="location-address">Location Address</label>
                                        <input type="text" class="form-control" name="location-address" placeholder="Address" required="">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="location-city">Location City</label>
                                        <input type="text" class="form-control" name="location-city" placeholder="City" required="">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="location-state">Location State</label>
                                        <select class="form-control" name="location-state" id="location-state" required="">
                                    ...
                                    <div class="form-group col-md-2">
                                        <label for="location-city">Location Zip</label>
                                        <input type="text" class="form-control" id="location-zip" name="location-zip" placeholder="Address">
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="nav-link" name="nav-link" class="form-control" placeholder="http://www.yourlinkwillgohere.com"  value="">
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary img-browser" data-setter="nav-link" type="button"><i class="fa fa-link" aria-hidden="true"></i></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="loc-img" id="loc-img" placeholder="No Image" value="">
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary img-browser" data-setter="loc-img" type="button">Browse Images</button>
                                        </div>
                                    </div>
                                    ...
                                    <br
                                    <label>Form Token</label>
                                    <input type="text" class="form-control" name="form-code" id="form-code" placeholder="Form Code" value="">
                                    <div class="clearfix"></div>
                                    <hr>
                                    <h3 style="display: inline-block">Location Phone Numbers</h3>
                                    ...
                                    <div class="loc-emails" style="padding: 5px; background: #eee">
                                        <div class="eml-grp row">
                                            ...
                                            <div class="form-group col-md-2">
                                                <label for="location-class">Class</label>
                                                <input style="background: #fff" type="text" class="form-control" name="email-class[]" placeholder="Style Class" value="">
                                            </div>
