...
$html .= '<div class="row"><div class="col-md-4"><img class="img-thumbnail" style="max-width: 300px;" src="../../../img/custom/'.$prodImg.'"></div>';
...
<div class="input-group mb-3">
                ...
                $html .= '<div class="col-md-4">';
$html .='<br><label>Parent Category</label><br><input class="form-control" name="parent_cat" id="parent_cat" type="text" style="margin-top:6px;" value="'.$product["parent_cat"].'"><br><br></div>';
$html .= '<div class="col-md-4">';
$html .= '<br><label>Title</label><br><input class="form-control" name="title" id="title" type="text" value="'.$product["title"].'"><br><br></div>';


$html .= '<div class="col-md-4">';
$html .= '<label>M.S.R.P Price (Integers Only)</label><br><input class="form-control" name="msrp" id="msrp" type="text" value="'.$product["msrp"].'"><br><br>';
...
$html .= '<div class="col-md-4">';
$html .='<label>Sales Price (Integers Only)</label><br><input class="form-control" name="sales_price" id="sales_price" type="text" value="'.$product["sales_price"].'"><br><br></div>';


$html .= '<div class="col-md-4">';

$html .='<label>SKU</label><br><input class="form-control" name="sku" id="sku" type="text" value="'.$product["sku"].'"><br><br></div>';

$html .= '<div class="col-md-4">';

$html .='<label>Weight (Integers Only)</label><br><input class="form-control" name="weight" id="weight" type="text" value="'.$product["weight"].'"><br><br></div>';

$html .= '<div class="col-md-4">';

$html .='<label>Dimensions (Example: 10X2X7)</label><br><input class="form-control" name="dimentions" id="dimentions" type="text" value="'.$product["dimentions"].'"><br><br></div>';
...
$html .= '<div class="col-md-12">';
$html .='<label>Description</label><br><br><textarea class="summernotes" name="features" id="features">'.$product["features"].'</textarea><br><br>';
$html .= '</div>';

$html .= '<div class="col-md-12"><label>Specs </label><br><textarea class="summernotes" id="description" name="description">'.$product["description"].'</textarea></div>';
$html .= '<div class="clearfix"></div>';
...
<script>
    ...
    function imgSucc(){
        console.log('Image added. You can close media manager.');
    }
