...
<div class="container-fluid" id="printOrder">
    ...
    if (count($cartItems) > 0) {
        ...
        for ($i = 0; $i < count($cartItems); $i++) {
            ...
            $x = $data->query("SELECT msrp, eq_image, discount, description, weight FROM $eqipTab WHERE id = '$eqipId'") or die("THIS IS ONE " . $data->error);
            $v = $x->fetch_array();
            ...
            $thePurchase .= '<div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table shoping-cart-table">
                                <tbody>
                                <tr class="d-flex flex-wrap mx-0 px-0">
                                    <td class="col-6 col-md-4 col-lg-2">
                                        <div class="cart-product-imitation"><img style="width: 100%" src="img/custom/' . $image . '">
                                        </div>
                                    </td>
                                    <td class="col-6 col-md-8 col-lg-6 desc">
                                        <h5 style="margin: 0">
                                            <a href="' . $cartItems[$i]["name"] . '" class="text-navy">
                                                ' . str_replace('-', ' ', $cartItems[$i]["name"]) . '
                                            </a>
                                        </h5>
                                    ...
                                    <td class="col-4 col-md-3 col-lg-1 offset-4 offset-md-6 offset-lg-0 pl-3">
  ...
  <div class="input-group-append">
...
</div><td class="d-none d-lg-flex d-lg-flex col-lg-1">
                                   
                                </td>
                                        
                                    </td>
                                    <td class=" col-4 col-md-3 col-lg-2 pr-3 text-right">
    ...
    $html .= ' <a class="btn btn-white" href="attachments"><i class="fa fa-arrow-left"></i> Continue shopping</a>
            ...
            <div class="col-12">
                <div class="ibox row flex-column align-items-end">
                    <div class="ibox-title">
                        <h5>Cart Summary</h5>
                    </div>
...
<div class="container-fluid">
    ...
    <div class="overlays"><div class="lds-ring"></div></div>
        <div class="row m-0" style="margin-bottom: 30px;">
            ...
            <div class="px-0 px-md-3 col-lg-7"><form name="billing_details" id="billing_details" method="post" action="">
                <div class="ibox">
                    <div class="ibox-title">
    ...
    $html .= '
            ...
            <div class="px-0 px-md-3 col-lg-5">';
    ...
    $thePurchase .= '<div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table shoping-cart-table">
                            <thead><tr class="row mx-0 px-0"><td class="col-7"><b>Item</b></td><td class="col-2"><b>Qty</b></td><td class="col-3 text-right"><b>Price</b></td></tr></thead>
                                <tbody>';
    ...
    for ($i = 0; $i < count($cartItems); $i++) {
        ...
        $thePurchase .= '
                                ...
                                <tr class="row mx-0 px-0" ' . $borderSty . '>
                                    <td class="desc col-7">
                                        <h5 style="margin: 0">
                                            <a href="' . $cartItems[$i]["name"] . '" class="text-navy-small" >
                                                ' . str_replace('-', ' ', $cartItems[$i]["name"]) . '
                                            </a>
                                        </h5>
                                        <small style="font-style: italic">$' . number_format($v["msrp"], 2) . ' ea</small><br>
    ...
    if ($savingCode == '') {
        ...
        $html .= '<form name="the-discount" id="the-discount" method="post" action=""><div class="px-0 py-3"><div class="input-group mb-3">
  ...
  <div class="input-group-append">
    <button class="btn btn-secondary my-0" type="submit">Redeem</button>
  </div>
</div></div></form>';
    }
    ...
    $html .= '<div class="ibox-content" style="text-align: right">
                    <span>
                        ...
                        <div class="m-t-sm">
                            <div class="btn-group col-12 px-0 justify-content-between align-items-center">
...
<div class="container-fluid">
    ...
    $html .= '<div class="col-6"><div class="ibox">';
  ...
  <div class="input-group-append">
    ...
    if ($sippingOptions != null) {
        ...
        $html .= '<select class="form-control mb-3" name="shipping_select" id="shipping_select" required="required"><option value="">Select Option</option> ';
        $chk = $data->query("SELECT setting_value FROM shop_settings WHERE setting_name = 'location_select'");
        $chk1 = $chk->fetch_array();
        if ($chk1["setting_value"] == 'true') {
        ...
        $html .= '<select name="pickup_location" id="pickup_location" class="form-control mb-3" required="required">';
...
<div class="container-fluid" id="printOrder">
    ...
    $html .= '<div class="ibox">
    <table style="width: 100%"><tr class="row"><td class="col-12 col-md-4">
                    <div class="ibox-title">
                        <h5>Store Location</h5>
                    </div>';
    $html .= '<div class="ibox-content">';
    ...
    $html .= '<td class="col-12 col-md-4"><div class="ibox">
    <div class="overlays"><div class="lds-ring"></div></div>
    ...
    $html .= '<td class="col-12 col-md-4"><div class="ibox" style="margin-bottom: 30px;">';
  ...
  <div class="input-group-append">
    ...
    $html .= '<div class="ibox-content" style="text-align: right">
                    ...
                    <h5>
                        ...
                        <div class="m-t-sm">
                            <div class="btn-group btn-group col-12 px-0 justify-content-between align-items-center">
                            <a href="checkout" class="btn-default btn-sm"><i class="fa fa-arrow-left"></i>  Back to Cart</a>
...
if ($act == 'complete_stripe_purchase') {
    ...
    if ($cartItems["shipping_type"] != 'Customer Pickup') {
        ...
        $chk = $data->query("SELECT setting_value FROM shop_settings WHERE setting_name = 'ship_type_global'");
