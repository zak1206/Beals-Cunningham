      ...
      <![endif]-->
        ...
        <div class="container-fluid">
            <div class="row no-gutter">
                <div class="col-6 col-sm-8 col-lg-4 my-auto px-0 px-sm-3">
                    <a class="navbar-brand" href="https://www.jamesriverequipment.com/">
                        <img class="navbar-logo col-12" src="img/JamesRiverLogo.png" alt="James River Logo" />
                    </a>
                </div>
                ...
                <div class="col-3 col-sm-2 col-lg-1 my-auto" align="right">
                    <!--cart start-->
                    <div class="cart-dropdown dropdown">
                        <!--<div class="cart-dropdown-menu" id="displayCartBlock" style="background-color: #ffff; margin-left: 20px; padding: 15px; display: none; width: 300px; border: 1px solid #EAEAEA;z-index: 2;top: 60px;right: -100%; position: absolute;" >
                        </div>--><a href="checkout">

                            <i class="fas fa-shopping-cart mx-5" style="width: 75px;margin-left: 25px;margin-right: 3px;padding: 8px;background: #005a9b;color: white;font-size: 25px;border-radius: 22px;box-shadow: 0px 6px 10px rgb(26 26 26 / 14%), 0px 1px 18px rgb(26 26 26 / 12%), 0px 4px 4px rgb(26 26 26 / 20%);"></i>
                        </a>
                    </div>
                    <!--cart end-->
                </div>
                <div class="col-3 col-sm-2 col-lg-1 my-auto" align="center">
                    <a href="mailto:info@jamesriverequipment.com"><img class="nav-icon d-none d-md-block" style="margin-left: 0px" src="img/nav-email.jpg" alt="Email Us" /></a>
