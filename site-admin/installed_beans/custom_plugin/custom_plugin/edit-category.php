...
?>
            ...
            <div class="row" style="margin: 0">
                ...
                <div class="col-md-8">
                    ...
                    <div class="content table-responsive table-full-width">
                        <form class="validforms" id="page-layout" name="page-layout" style="padding: 20px" method="post" action="">
                            ...
                            <textarea class="summernote" id="page_template" name="page_template"><?php echo $page_template; ?></textarea>
                            <?php echo $existPage; ?>
                            <br><br>
                ...
                <div class="col-md-4">
                    ...
                    <div style="text-align: right">
                        <a href="custom-categories.php"><i class="fa fa-chevron-left"></i> Back To Categories</a>
                    </div>
                    ...
                    <div style="background: #efefef; padding: 20px; margin: 3px">
                        ...
                        <div class="productitem draggable" data-thename="" data-listtype="htmlarea" style="padding: 5px; text-align: center; background: #fff; margin: 5px; cursor:pointer">
                            <div class="row">
                                ...
                                <div class="col-md-10" style="text-align: left"><i class="fa fa-list-alt" aria-hidden="true"></i> HTML Container</div>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function openRevision(id) {
            $.ajax({
                url: 'asyncData.php?action=captureversion&id=' + id,
                success: function(data) {
        ...
        function restoreVersionFin(id, type) {
            $.ajax({
                url: 'asyncData.php?action=restoreversion&id=' + id + '&type=' + type,
                success: function(data) {
        ...
        function lockPage(id) {
            $.ajax({
                dataType: "json",
                url: 'asyncData.php?action=lockpage&id=' + id,
                success: function(data) {
                    if (data != 'issues') {
        ...
        function reviewSource(id) {
            $.ajax({
                url: 'asyncData.php?action=reviewcodes&id=' + id,
                success: function(data) {
                    $("#myModalAS .modal-body").html(data);
