...
$prodImg1 = str_replace('"','',$product["eq_image"]);
$prodImg2 = str_replace('[','',$prodImg1);
$prodImg = str_replace(']','',$prodImg2);
$html .= '<img class="img-thumbnail" style="max-width: 300px;" src="../../../img/custom/'.$prodImg.'">';
...
<p style="font-size:10px;">Only extension with .png and .jpg - remove all characters</p>
<div class="input-group mb-3">
                    <input type="text" class="form-control" name="cat_img" id="cat_img" placeholder="No Image" aria-label="Category Image" value="'.$prodImg.'">
                    <div class="input-group-append">
                        <button class="btn btn-success img-browser" data-setter="cat_img" type="button">Browse Images</button>
                    </div>
                </div>';
$html .='<br><label>Parent Category</label><br><input class="form-control" name="parent_cat" id="parent_cat" type="text" style="margin-top:6px;" value="'.$product["parent_cat"].'"><br><br>';

$html .= '</div>';
$html .= '<div class="col-md-4">';
$html .= '<label>M.S.R.P Price Info:</label><br><p style="font-size:10px;"></p><input class="form-control" name="msrp" id="msrp" type="text" style="margin-top:31px;" value="'.$product["msrp"].'"><br><br>';
$html .= '<label>Title</label><br><input class="form-control" name="title" id="title" type="text" value="'.$product["title"].'"><br><br>';
$html .= '</div>';
$html .= '<div class="col-md-4">';
$html .='<label>Sales Price</label><br><p style="font-size:10px;"></p><input class="form-control" name="sales_price" id="sales_price" type="text" style="margin-top:31px;" value="'.$product["sales_price"].'"><br><br>';
$html .= '</div>';

$html .= '<div class="clearfix"></div>';
$html .= '<div class="col-md-12">';
$html .='<label>Description</label><br><p style="font-size:10px;"></p><textarea class="form-control" name="features" id="features">'.$product["features"].'</textarea><br><br>';
$html .= '</div>';

//$html .= '<div class="col-md-12"><p>Below you can turn on and off each product section fed by custom.</p></div>';
...
//$html .= '<div class="col-md-4"><label>Quick Links</label><br><span class="quick-links" style="font-size: 40px;color: #21d021;"><i class="fa '.$quick.' fa-3 thetoggle" data-elmclos="quick_links_active" aria-hidden="true"></i><input type="hidden" name="quick_links_active" id="quick_links_active" value="'.$product["quick_links_active"].'"></span></div>';
...
//$html .= '<div class="clearfix"></div>';
$html .= '<div class="col-md-12"><label>Specs </label><br><br><textarea class="summernotes" id="description" name="description">'.$product["description"].'</textarea></div>';
$html .= '<div class="clearfix"></div>';
