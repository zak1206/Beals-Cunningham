...
$modFolder = 'installed_beans/kuhn_plugin';
...
if(isset($_REQUEST["createnew"])){
  ...
  <strong>Well done!</strong> Your page has been saved successfully.
    ...
    <div class="col-md-8">
        ...
        <div class="content table-responsive table-full-width">
            <form class="validforms" id="page-layout" name="page-layout" style="padding: 20px" method="post" action="">
                <input type="hidden" name="line_type" id="line_type" value="kuhn">
    ...
    <div class="col-md-4">
        ...
        $cats = $kuhn->getEquipmentProducts('','');
...
$id = $_REQUEST["eqid"];
$pageDetails = $kuhn->getDeerePage($id);
...
?>
    ...
    <div class="row" style="margin: 0">
        ...
        <div class="col-md-8">
            ...
            <div class="header">
                <h4 class="title">Edit Kuhn Equipment Category</h4>
                <p class="category">Use this to create custom categories for equipment.</p>
...
<?php }else{ ///SHOW LIST VIEW ?>
    ...
    <div class="header">
        ...
        <div class="clearfix"></div>
        <h4 class="title">Kuhn Category Templates</h4>
        <p class="category">Here are your sites custom Kuhn categories.<br></p>


        <?php
        $pageCheck = $kuhn->checkPages();
        ...
        <?php
        if($kuhn->checkUpdates() != null){

            $updateInfo = $kuhn->checkUpdates();
        ...
        <div class="col-md-6" style="text-align: right">
            <?php echo $pageButton; ?> <button class="btn btn-warning mod-prods" style="margin: 20px;color: #fff;">Manage Products</button> <a href="?createnew=true" class="btn btn-success btn-fill" style="margin: 20px">Create New Category</a>
        </div>
        </div>
        <div class="clearfix"></div>
    </div>
    ...
    <script>
        ...
        $(function(){
            $(".mod-prods").on('click',function(){
                $.ajax({
                    ...
                    success:function(data){
                        $("#myModal .modal-body").html(data);
                        $("#myModal .modal-title").html('Manage Kuhn Products');
                        $("#myModal").modal();
                        $(".modal-dialog").css('width','70%');
                    }
                })
        ...
        function processsPages(){
            $(".inspg").html('Installing Page Data... <img style="width: 18px; padding: 1px;" src="installed_beans/kuhn_plugin/loading.gif"> ');
            $.ajax({
        ...
        function openUpdatePanel(){
            ...
            $("#myModal .modal-body").html('<h2>Kuhn Plugin Updates</h2><br><small><i>Release Date: '+update_date+' Version: '+version+'</i></small><br><br>'+update_notes+'<br><div style="display: none; padding: 10px; background: #efefef;" class="loadarea"><br><div class="progress" style="height: 2px;">\n' +
            ...
            $("#myModal .modal-title").html('Update Kuhn Plugin');
