...
?>
    <button style="float: right; margin: 10px" class="btn btn-primary" onclick="history.back()">Back To Sliders</button> <button style="float: right; margin: 10px" class="btn btn-warning" onclick="slidesholders()">Add New Slide</button>
    <div class="clearfix"></div>
    <br>
