...
$modFolder = 'installed_beans/honda_plugin';
    ...
    <div class="col-md-8">
        ...
        <div class="content table-responsive table-full-width">
            <form class="validforms" id="page-layout" name="page-layout" style="padding: 20px" method="post" action="">
                <input type="hidden" name="line_type" id="line_type" value="honda">
...
<div class="card">
        <div class="col-md-8">
            ...
            <div class="header">
                <h4 class="title">Edit Honda Equipment Category</h4>
                <p class="category">Use this to create custom categories for equipment.</p>
...
<div class="card">
                    <div class="header">
                        <img style="margin: 15px 0px;float: right;" src="img/honda_logo.png">
                        <div class="clearfix"></div>
                        <h4 class="title">Honda Category Templates</h4>
                        <p class="category">Here are your sites custom Honda categories.<br></p>


                        <?php
                        $pageCheck = $honda->checkPages();
                        ...
                        <?php
                        if($honda->checkUpdates() != null){

                            $updateInfo = $honda->checkUpdates();
...
<script>
    ...
    $(function(){
        $(".mod-prods").on('click',function(){
            $.ajax({
                ...
                success:function(data){
                    $("#myModal .modal-body").html(data);
                    $("#myModal .modal-title").html('Manage Honda Products');
                    $("#myModal").modal();
                    $(".modal-dialog").css('width','70%');
                }
            })
    ...
    function processsPages(){
        $(".inspg").html('Installing Page Data... <img style="width: 18px; padding: 1px;" src="installed_beans/honda_plugin/loading.gif"> ');
        $.ajax({
    ...
    function openUpdatePanel(){
        ...
        $("#myModal .modal-body").html('<h2>Honda Plugin Updates</h2><br><small><i>Release Date: '+update_date+' Version: '+version+'</i></small><br><br>'+update_notes+'<br><div style="display: none; padding: 10px; background: #efefef;" class="loadarea"><br><div class="progress" style="height: 2px;">\n' +
        ...
        $("#myModal .modal-title").html('Update Honda Plugin');
