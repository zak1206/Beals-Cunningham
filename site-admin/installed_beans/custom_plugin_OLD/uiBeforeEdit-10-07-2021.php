...
if(isset($_REQUEST["createnew"])){
  ...
  <strong>Well done!</strong> Your page has been saved successfully.
    ...
    <div class="col-md-4">
        ...
        $cats = $custom->getEquipmentProducts('','');
...
$id = $_REQUEST["eqid"];
$pageDetails = $custom->getDeerePage($id);
...
?>
    ...
    <div class="row" style="margin: 0">
        ...
        <div class="col-md-8">
            ...
            <div class="header">
                <h4 class="title">Edit Custom Equipment Category</h4>
                <p class="category">Use this to create custom categories for equipment.</p>
...
<?php }else{ ///SHOW LIST VIEW ?>
    ...
    <div class="header">
        <img style="margin: 15px 0px;float: right;" src="../../../../img/CustomProductsLogo.png">
        <div class="clearfix"></div>
        <h4 class="title">Custom Category Templates</h4>
        <p class="category">Here are your sites custom custom categories.<br></p>


        <?php
        $pageButton = '<button class="btn btn-danger" style="float:right; margin: 20px; background: #EB5E28; color: #fff; min-width:200px;" onclick="location.href=\'custom.php\'" >Add Custom Products</button>';
        ?>

        <?php
        if($custom->checkUpdates() != null){

            $updateInfo = $custom->checkUpdates();
        ...
        <div class="col-md-6" style="text-align: right">
            <?php echo $pageButton; ?>
            <button class="btn btn-warning mod-prods" style="margin: 20px;color: #fff; min-width:200px;">Manage Products</button> <a href="?createnew=true" class="btn btn-success btn-fill" style="margin: 20px;min-width:200px;">Create New Category</a><button class="btn btn-primary" style="float:right; margin: 20px; background: #007bff; color: #fff; min-width:200px;" onclick="location.href='index-export.php'" >Import/Export Data</button><button class="btn btn-dark" style="float:right; margin: 20px; color: #fff; min-width:200px;" onclick="location.href='google.php'" >Google Shopping</button><button class="btn btn-dark" style="float:right; margin: 20px; color: #fff; min-width:200px;" onclick="location.href='google-index-export.php'" >Google Import/Export Data</button>
        </div>
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="content table-responsive table-full-width">
        <table class="table table-striped">
            ...
            <?php
            //$site->checkInPages();
            $pages = $custom->getPagesCat('custom');
            $j = 0;
    ...
    <script>
        ...
        function processsPages(){
            $(".inspg").html('Installing Page Data... <img style="width: 18px; padding: 1px;" src="installed_beans/custom_plugin/loading.gif"> ');
            $.ajax({
