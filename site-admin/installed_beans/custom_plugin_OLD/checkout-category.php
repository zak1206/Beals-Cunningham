       ...
       <div class="col-md-12">
        <div class="card">
         ...
         <div class="col-md-4">
          ...
          <div style="background: #efefef; padding: 20px; margin: 3px">
           <div style="text-align: center">
            <h4>HTML Info</h4><small>Drag & drop html container to add html inside product container.</small>
           </div>
           <div class="productitem draggable" data-thename="" data-listtype="htmlarea" style="padding: 5px; text-align: center; background: #fff; margin: 5px; cursor:pointer">
            <div class="dragsa col-md-2" style="cursor:move; text-align: left"><img style="width: 6px" src="img/grip.png"></div>
            <div class="col-md-10" style="text-align: left">HTML Container <i class="fa fa-list-alt" aria-hidden="true"></i></div>
            <div class="clearfix"></div>
           </div>
          </div>
          <div style="background: #efefef; padding: 20px; margin: 3px">
           <h4 style="text-align: center">Created Categories</h4>
           <div class="col-md-12">
            ...
            <div class="input-group col-md-12" style="margin-top:10px">
             <input type="text" style="background: #fff" class="form-control" name="cat_ser" id="cat_ser" placeholder="Search Categories" data-list=".custcats" autocomplete="off" value=""> <span class="input-group-btn"><button class="btn btn-primary ser-thcats" style="border: solid thin #ccc;background: #cccccc; color: #333;" type="button">Search</button></span>
            </div>
           </div>
           <div class="custcats" style="height: 250px; overflow-y:scroll; width: 100%"><?php echo $categoryOutReal; ?></div>
          </div>
          <div class="productslist" style="background: #efefef; padding: 20px; margin: 3px;">
           <h4 style="text-align: center">Browse Products</h4><?php echo $categoryOut; ?>
          </div>
         </div>
         <div class="clearfix"></div>
        </div>
      ...
      <?php } else { ?>
         ...
         <div class="col-md-12">
          <div class="card">
           <div class="header">
            ...
            ?>
            <div class="alert alert-warning" style="padding: 20px; font-size: 20px"><strong><i class="ti-alert"></i> Whoops!</strong> - It appears this page is already checked out.<p>Please correspond with the other member editing this page to make changes </p>
             <p>Currently checked out by: <a href="" style="color: #333; text-decoration: underline"><?php echo $checkedDetails["fname"]; ?></a> @ <?php echo $checkoutDate; ?></p>
            </div>
           </div>
           <br>
          </div>
       ...
       <script>
        ...
        function savePage(checkout) {
         if (checkout == 'true') {
          $('#page-layout').prepend('<input type="hidden" name="checkout" id="checkout" value="true" />');
         }
