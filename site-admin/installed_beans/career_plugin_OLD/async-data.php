...
if ($act == 'readjob') {
    ...
    $html .= '<div style="height: 30px"></div>';
    //$html .= '<div class="panel panel-success"> <div class="panel-heading" style=""> <!--<h3 class="panel-title" style="background:#457442; color: white; padding: 0px 20px;">Qualifications</h3> </div> <div class="panel-body">' . $b["qualifications"] . '--><a class="btn btn-success" href="application-form?careertitle=' . str_replace(' ', '-', $careertitle) . '&careerlocation=' . str_replace(' ', '-', $locationDetails) . '">Apply</a></div> </div>';
    $html .= '<div class="panel panel-success"> <div class="panel-heading" style=""> <!--<h3 class="panel-title" style="background:#457442; color: white; padding: 0px 20px;">Qualifications</h3> </div> <div class="panel-body">' . $b["qualifications"] . '--><a class="btn btn-success" href="https://careers.brandtholdings.com/">Apply</a></div> </div>';

    // <a class="btn btn-success" href="Apply?careertitle='.str_replace(' ','-', $careertitle).'&careerlocation='.str_replace(' ','-', $locationDetails).'">Apply</a>
