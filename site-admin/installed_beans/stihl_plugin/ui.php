...
$modFolder = 'installed_beans/stihl_plugin';
include('functions.php');
$stihl = new stihlClass();
...
if(isset($_REQUEST["createnew"])){
  ...
  <strong>Well done!</strong> Your page has been saved successfully.
    ...
    <div class="col-md-8">
        ...
        <div class="content table-responsive table-full-width">
            <form class="validforms" id="page-layout" name="page-layout" style="padding: 20px" method="post" action="">
                <input type="hidden" name="line_type" id="line_type" value="stihl">
    ...
    <div class="col-md-4">
        ...
        $cats = $stihl->getEquipmentProducts('','');
...
$id = $_REQUEST["eqid"];
$pageDetails = $stihl->getDeerePage($id);
...
?>
    ...
    <div class="row" style="margin: 0">
        ...
        <div class="col-md-8">
            ...
            <div class="header">
                <h4 class="title">Edit Stihl Equipment Category</h4>
                <p class="category">Use this to create custom categories for equipment.</p>
...
<?php }else{ ///SHOW LIST VIEW ?>
    ...
    <div class="header">
        ...
        <?php
        if($stihl->checkUpdates() != null){

            $updateInfo = $stihl->checkUpdates();
    ...
    <script>
        ...
        function processsPages(){
            $(".inspg").html('Installing Page Data... <img style="width: 18px; padding: 1px;" src="installed_beans/stihl_plugin/loading.gif"> ');
            $.ajax({
        ...
        function openUpdatePanel(){
            ...
            $("#myModal .modal-body").html('<h2>Stihl Plugin Updates</h2><br><small><i>Release Date: '+update_date+' Version: '+version+'</i></small><br><br>'+update_notes+'<br><div style="display: none; padding: 10px; background: #efefef;" class="loadarea"><br><div class="progress" style="height: 2px;">\n' +
            ...
            $("#myModal .modal-title").html('Update Stihl Plugin');
