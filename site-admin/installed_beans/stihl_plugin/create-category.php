...
<?php echo $alert; ?>
    ...
    <div id="js_editor" class="header">
        ...
        <p class="category">NOTICE! - Javascript event cannot be added to newly created pages. In order to apply JS event you will need to save page and go to edit page.</p>
        <br>
    </div>
