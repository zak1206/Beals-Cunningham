...
$prodImg = str_replace('"','',$product["eq_image"]);
$html .= '<img class="img-thumbnail" style="max-width: 300px;" src="../../../img/equip_images/'.$prodImg.'">';
...
$html .= '</div>';
$html .= '<div class="col-md-4">';
$html .= '<label>M.S.R.P Price Info:</label><br><input class="form-control" name="msrp" id="msrp" type="text" value="'.$product["msrp"].'"><br><br>';
$html .= '</div>';
$html .= '<div class="col-md-4">';
...
$html .= '<div class="col-md-12"><p>Below you can turn on and off each product section fed by Stihl.</p></div>';
