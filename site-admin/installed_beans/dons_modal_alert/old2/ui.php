...
<p>Use the below settings to create and edit your sites media modal.</p>
<hr>
...
?>
    ...
    <button style="float: right; margin: 10px" class="btn btn-warning" onclick="slidesholders()">Add New Modal</button>
    <div class="clearfix"></div>
    <br>
...
<?php
    ...
    ?>
    <button class="btn btn-outline-primary" style="float: right; margin: 10px" onclick="createNewSlide()">Create New Modal</button>
...
<script>
    ...
    function createNewSlide(){
        $("#slidestuff .modal-title").text('Create New Modal');
