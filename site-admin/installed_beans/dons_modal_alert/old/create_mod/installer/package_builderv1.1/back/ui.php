...
<script>
    ...
    function startDrag(){
        ...
        $( ".droparea" ).droppable({
            ...
            drop: function( event, ui ) {
                ...
                if(ui.draggable.data('thename') == undefined) {
    ...
    function quickLineEdit(id) {
        $.ajax({
            ...
            cache: false,
            success: function(data){
                $("#example_wrapper").html(data.html);
    ...
    function updateOfferDetails(){
        $("#package-offer").validate({

            submitHandler: function(form) {

                $.ajax({
                    type: "POST",
                    url: "asyncData.php?action=updateOfferDetails",
                    cache: false,
                    data: $("#package-offer").serialize(),
                    success: function(data)
                    {
                        swal({
                            title: 'Your Custom Offers Have Been Updated',
                            text: 'I will now close.',
                            type: 'success',
                            timer: 2000
                        }).then(
    ...
    function getOfferDetails(){
        $('.offer-btn').click(function(){
            ...
            $.ajax({
                url: 'asyncData.php?action=getoffers&id='+equipid,
                cache: false,
                success: function(offs){
                    $("#offerModal .modal-title").html('<h2>'+equipid+' Offers Available</h2>');
                    $("#offerModal .modal-body").html(offs);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $(".offer-toggle").click(function(){
                    $(".offer-package-area").slideToggle();
                });
                $('#implements').sortable();
