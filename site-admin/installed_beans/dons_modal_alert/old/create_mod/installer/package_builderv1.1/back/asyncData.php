                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                         ...
                         <label>Implements Included</label>
                            <div id="implements" class="droparea ui-droppable ui-sortable" style="background: #efefef; border:dashed thin #a0a0a0; padding: 30px; scroll: auto;"></div>
                         <label>Attachments Included</label>
                        <div id="attachments" class="droparea ui-droppable ui-sortable" style="background: #efefef; border:dashed thin #a0a0a0; padding: 30px; scroll: auto;"></div>
                    </div>
...
if($act == 'editpackage') {
    ...
    $html .= '</select>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="hidden" name="lines" id="lines" value="">
                         <label>Implements Included</label>
                            <div id="implements" class="implements droparea ui-droppable ui-sortable" style="background: #efefef; border:dashed thin #a0a0a0; padding: 30px; scroll: auto;">';
                            ...
                            $html .= '</div>
                         <label>Attachments Included</label>
                         <div id="attachments" class="droparea ui-droppable ui-sortable" style="background: #efefef; border:dashed thin #a0a0a0; padding: 30px; scroll: auto;">';
