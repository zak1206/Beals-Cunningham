  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="package_builder_form" id="package_builder_form" role="form" method="post" action="">
    <div class="row">
...
<div id="buildertop"></div><div class="container-fluid"> 
                    ...
                    <button type="button" class="step-trigger" role="tab" id="stepper1trigger1" aria-controls="test-l-1" onclick="stepper.to(1)"> <span class="bs-stepper-circle">1</span> <span class="bs-stepper-label"></span> Select Equipment </button>
                     </div> <div class="bs-stepper-line">
                     </div> 
                     <div class="step" data-target="#test-l-2"> <button type="button" class="step-trigger" role="tab" id="stepper1trigger2" aria-controls="test-l-2"  onclick="stepper.to(2)"> <span class="bs-stepper-circle">2</span> 
                     <span class="bs-stepper-label">Implements</span> </button> </div> <div class="bs-stepper-line"></div> <div class="step" data-target="#test-l-3"> 
                     <button type="button" class="step-trigger" role="tab" id="stepper1trigger3" aria-controls="test-l-3"  onclick="stepper.to(3)"> <span class="bs-stepper-circle">3</span> 
