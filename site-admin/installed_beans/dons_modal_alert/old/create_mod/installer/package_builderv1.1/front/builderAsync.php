...
if($act == 'getfinal') {
    ...
    $html .= '<div class="row">';
    $html .= '<div class="col-md-6"><img src="img/equip_images/'.$image[0].'" class="img-responsive"><a class="text-center" href="'.$brochlink.'" target="_blank">View Brochure</a><br><button type="button" class="btn btn-warning previous" style="float: left;" onclick="stepper.previous()">Previous</button><button type="button" class="btn btn-success offer-btn" data-toggle="modal" onclick="getOffers('.$equip["id"].')">
