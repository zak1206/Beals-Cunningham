...
if(isset($_POST["site_name"])){
    $site->updateSiteSettings($_POST);
    $coreMessage = '<div class="alert alert-success">
  <strong>Success!</strong> Your site settings have been updated.
</div>';
}else{
    $coreMessage = '';
}
...
if(isset($_POST["admin_logo"])){
    $site->updateAdminColors($_POST);
    $adminMessage = '<div class="alert alert-success">
  <strong>Success!</strong> Your admin color settings have been updated.
</div>';
}else{
    $adminMessage = '';
}
...
if(isset($_POST["site_domain"])){
    $site->createSiteMap($_POST["site_domain"]);
    $sitemapMessage = '<div class="alert alert-success">
  <strong>Success!</strong> Your sitemap has been created. You can find it on the root of your site.
</div>';
}else{
    $sitemapMessage = '';
}
...
$admin_logo = $siteSettings["admin_logo"];
$admin_color = $siteSettings["admin_color"];
$default_color = $siteSettings["default_color"];
$success_color = $siteSettings["success_color"];
$primary_color = $siteSettings["primary_color"];
$warning_color = $siteSettings["warning_color"];
$danger_color = $siteSettings["danger_color"];
$timezones_out = $siteSettings["timezone"];

echo "THis is ".$timezones;

if($admin_logo == ''){$admin_logo = 'img/caffeine_logo.png';}
if($admin_color == ''){$admin_color = '#1abc9c';}
if($default_color == ''){$default_color = '#e0e0e0';}
if($success_color == ''){$success_color = '#1abc9c';}
if($primary_color == ''){$primary_color = '#337ab7';}
if($warning_color == ''){$warning_color = '#FDAD4E';}
if($danger_color == ''){$danger_color = '#d9534f';}
?>
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb float-right">
                                        ...
                                        <li class="breadcrumb-item active">System Default Information</li>
                                    </ol>
                        ...
                        <div class="card-box" style="margin-top:20px">
                            <div style="padding: 20px">
                                <h4 class="m-t-0 header-title">System Default Information</h4>
                                <p class="text-muted font-14 m-b-30">
                                    Update Site Name, Description & Keywords for Home Page.
                                </p>

                                <div style="clear:both;"></div>
                                <hr>
                                <?php echo $coreMessage; ?>
                                <form id="site-settings" name="site-settings" method="post" action="">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>Site Name</label><br>
                                            <input class="form-control" type="text" id="site_name" name="site_name" value="<?php echo $site_name; ?>" required="">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <textarea class="form-control" name="site_description" id="site_description"><?php echo $site_description; ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label>Site Keywords <br><small>Seporate each keyword with a comma ,</small></label><br>
                                            <textarea class="form-control" name="site_keywords" id="site_keywords"><?php echo $site_keywords; ?></textarea>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <label>Site TimeZone <br><small>Set the default timezone for the site.</small></label><br>
                                            <select class="form-control" name="timezone_set" id="timezone_set">
                                    ...
                                    <div class="row" style="">
                                        <div class="col-md-8">
                                            <label>Insert Google Analytics code or anything you would like fired before closing <xmp style="display: inline-block;"></head></xmp> Tag.</label><br>
                                            <textarea class="form-control my_codemirror_html" name="google_analytics" id="google_analytics"><?php echo $google_analytics; ?></textarea>
                                        </div>
                                    </div>
