              ...
              //  echo 'false';
                ...
                if($b["api_price_active"] == 'true') {
                    ...
                    if($theprice != '' && $b["dealer_price"] != '') {
                        ...
                        $pricepresent = '<span class="startingat">Starting At:</span><span class="equipprice">' . $b["price"] .'</span>';
                        $ifcart = '<button class="btn btn-dark save-later" data-eqid="'.$b["id"].'" data-eqname="'.$b["title"].'" data-eqtype="deere" data-price="'.$b["price"].'" data-url="'.$actual_link.'"> Add To Cart <i class="fa fa-shopping-cart"></i></button>';
                    } else {
                        $pricepresent = '';
                        $ifcart = '';
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
            ...
            <div class="col-md-4 col-sm-12">
                ...
                <h1 class="model"><span class="brand"></span>'.strtoupper(substr($title, 0, strpos($title, "-"))).'<br></h1>
...
//});</script>';
            ...
            <div class="card" style="margin-bottom: 20px;">
                ...
                <div class="product-content" style="padding: 20px">
                    <h3 class="title" style="font-size: 1.3rem;"><a href="'.$_SERVER['REQUEST_URI'].'/'.$d["page_name"].'">'.strpos('-',' ', $d["page_name"]).'</a></h3>
            ...
            <div class="card">
                ...
                <div class="product-content">
                    <h3 class="title" style="margin-bottom: 0; background: #346635; color: white;"><a style="color: white; padding-left: 20px;"href="' . $_SERVER['REQUEST_URI'] . '/' . $f["title"] . '">' . $f["title"] . '</a></h3>
                ...
                if (strpos($_SERVER['REQUEST_URI'], 'Used-Equipment') != true) {
                    ...
                    $content[] = array("page_name" => 'CATEGORY PAGE', "page_title" => 'CATEGORY PAGE', "page_content" => $categoryOut, "active" => true, "created" => time(), "last_edit" => '', "last_user" => '', "page_lock" => 'none', "page_type" => '', "page_desc" => '', "check_out" => false, "check_out_date" => '', "page_js" => '');
                    return $content;
                }
            }else{
