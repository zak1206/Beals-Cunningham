                        ...
                        <div class="card-box" style="margin-top:20px">
                            ...
                            <?php
                                ...
                                if($record["bean_type"] == 'installed'){
                                    ...
                                    echo '<iframe id="content" onload="resizeIframe(this)" style="width:100%; height:100vh; border:none" src="installed_beans/'.$record["bean_folder"].'/ui.php" width="300"></iframe>';
                                    echo '</div>';
