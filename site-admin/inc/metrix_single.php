...
<input class="form-control" type="text" id="urlrun" name="urlrun" value="">
...
<script>
    ...
    function loadClient() {
        gapi.client.setApiKey("AIzaSyD97gowyEmaJEmqNKWd9BwT0ajBOVbgIYU");
        ...
        return gapi.client.pagespeedonline.pagespeedapi.runpagespeed({
            ...
            .then(function(response) {
                ...
                if (result4) {
                    ...
                    $(".thetabs").html('<br><br><table class="table" style="width:100%"><tr><td>'+urltest+'</td><td>'+performance+'</td><td>'+accessibility+'</td><td>'+bestpractices+'</td><td>'+seo+'</td></tr></table>')
