...
["bootstrap4/signin-split", "bootstrap4/location-side", "bootstrap4/slider-header", "bootstrap4/image-gallery", "bootstrap4/video-header", "bootstrap4/about-team", "bootstrap4/portfolio-one-column", "bootstrap4/portfolio-two-column", "bootstrap4/portfolio-three-column", "bootstrap4/portfolio-four-column"];
...
Vvveb.Blocks.add("bootstrap4/location-side", {
    name: "Location Side Bar",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/image.svg">',
    image: "https://startbootstrap.com/assets/img/screenshots/snippets/about-team.jpg",
    html:`<div><h4>Location Name</h4><p>This is some information</p></div>
`,
});
