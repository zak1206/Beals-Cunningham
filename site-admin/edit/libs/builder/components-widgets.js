...
Vvveb.ComponentsGroup['Widgets'] = ["widgets/systemforms", "widgets/googlemaps", "widgets/video", "widgets/chartjs", "widgets/facebookpage", "widgets/paypal", "widgets/instagram", "widgets/twitter"/*, "widgets/facebookcomments"*/];

Vvveb.Components.extend("_base", "widgets/systemforms", {
    name: "System Forms",
    attributes: ["data-component-systemforms"],
    image: "icons/form.svg",
    dropHtml: '<img src="' + Vvveb.baseUrl + 'icons/facebook.png">',
    html: '<div class="form-box" data-component-systemforms>FORMS HERE</div>',
    properties: [{
        name: "Select Form",
        key: "select-form",
        htmlAttr: "data-system-form",
        inputtype: FormBrowse
    }],
    onChange: function() {
