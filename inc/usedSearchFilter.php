...
<div style="padding: 0px">
    <p style="font-size: 32px; color:#fff; font-weight: lighter; margin-bottom: 0px;" align="center" style="font-weight: lighter;"><i>Entire Site Search</i></p>
    <form id="site-search" name="site-search" action="Search-Results" method="post">
        <input class="form-control py-2" style="border-radius: 25px; display: inline-block;" type="search" name="serterm" id="serterm" pattern=".{3,}" title="At least 3 characters" required autocomplete="off" placeholder="Search...">
        <div style="clear: both;"></div>
    </form>
 <br>
 <hr style="border: solid thin #fff; display: none;">
 <h2 style="color:#fff; margin-top: 40px;" align="center">USED EQUIPMENT SEARCH</h2>
 ...
 <div class="tab-content">
  <div id="used-equipment" class="tab-pane active">
   ...
   <form name="quickserc" id="quickserc" action="Used-Equipment" method="post">
    ...
    <br>
    <label style="color: #fff;">Manufacturer</label><br>
    ...
    <div class="row" align="center">
     <div class="col-md-12"><button class="btn btn-success quick-search-btn" align="center">Search</button></div>
    </div>
   </form>
  </div>
 </div>
 <br/>
 <p class="text-white" align="center" style="font-size: 42px; line-height: .9;"><b>Legacy</b><br/><span style="font-weight: lighter;">Leads.</span></p>
</div>