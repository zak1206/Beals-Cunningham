...
<![endif]-->
        ...
        <div class="container-fluid p-0 navigation">
            <div class="row text-white my-auto" style="background-color: #367C2B;">
                <div class="col-md-12 my-auto desktop">
                    <div class="green-nav-container d-flex justify-content-end my-auto">
                        ...
                        <p class="proxima-nova light desktop" style="margin-top: 4px; font-size: 16px;"><i> 1-800-555-5555</i></p>
                        <i class="fas fa-envelope" style="margin-left: 20px; font-size: 20px; margin-top: 4px;"></i>
                        <p class="proxima-nova light desktop" style="margin-top: 4px; font-size: 16px;"><i> Info@StellarEquipment.com</i></p>
                        <i class="fas fa-map-marker-alt" style="margin-left: 20px; font-size: 20px; margin-top: 4px;"></i>
                        <p class="proxima-nova light desktop" style="margin-top: 4px; font-size: 16px;"><i> Find a Store</i></p>
            ...
            <div class="row main-nav" style="margin-top: -10px;">
                ...
                <div class="col-sm-9 col-md-10 justify-content-end d-flex my-auto" style="color: white;">
                        ...
                        <div class="collapse navbar-collapse desktop">{nav}main{/nav}
                            ...
                            <div class="cart-dropdown dropdown">
                                <div data-toggle="dropdown" style="background-color: transparent; border: none;">
                                    <img src="../../../../img/shopping-cart.png" style="width: 24px;"> <span class="cartcount badge badge-pill badge-dark" style="background-color: #367C2B; color: white;">0</span>
                                </div>
                                <div class="cart-dropdown-menu dropdown-menu">
...
<!-- search -->
            <form id="site-search" name="site-search" action="Search-Results" method="post" style="display: none; width: 1300px;">
            	<div class="top-nav-static">
					<input style="width: 100vw; padding: 10px;background: #333;border: none;color: #a7a7a7;font-size: 30px;text-align: center; outline: none;" type="text" name="serterm" id="serterm" pattern=".{3,}" title="At least 3 characters" required autocomplete="off" placeholder="Search Site...">
                </div>
