		...
		<div class="col-md-12 col-lg-8 toggle-desktop" align="right">
			<div class="navbar-links-container">
				...
				<div class="navbar-links">
					<a href="Careers" class="nav-link"><p><b>Careers</b></p></a>
					<a href="Parts" class="nav-link"><p><b>Buy Parts Now</b></p></a>
					<a href="customer-portal"><button class="btn btn-green">Customer Portal</button></a>
				</div>
			</div>
		</div>
	</div>
