...
<![endif]-->
		...
		<div class="container-fluid p-0">
			<div class="row text-white my-auto" style="background-color: #367C2B; height: 30px;">
				<div class="col-md-12">
					<div class="green-nav-container d-flex justify-content-end my-auto">
                      <i class="fas fa-phone-alt"></i> <p class="proxima-nova light"><i>1-800-635-8945</i></p>
                      <i class="fas fa-envelope" style="margin-left: 20px;"></i> <p class="proxima-nova light"><i>Info@StellarEquipment.com</i></p>
                      <i class="fas fa-map-marker-alt" style="margin-left: 20px;"></i> <p class="proxima-nova light"><i>Find a Store</i></p>
                      <a href="facebook.com" style="margin-left: 20px;"><i class="fab fa-facebook-f"></i></a>
                      <a href="instagram.com" style="margin-left: 6px;"><i class="fab fa-instagram"></i></a>
                      <a href="twitter.com" style="margin-left: 6px;"><i class="fab fa-twitter"></i></a>
                      <a href="youtube.com" style="margin-left: 6px; margin-right: 5%;"><i class="fab fa-youtube"></i></a>
                    </div>
				</div>
			</div>
            <div class="row" style="background-color: #181E22; margin-left: 5%; margin-right: 5%;">
            	<div class="col-md-2 my-auto">
                    <a class="navbar-brand" href="home">
                        <img src="img/Stellar-Logo-White.png" alt="Stellar Equipment Logo" width="175px"/>
                    </a>
                </div>
                <div class="col-md-10 justify-content-end d-flex" style="color: white;">
        ...
        <!-- Old Navigation -->
        <div class="container-fluid p-0 navigation-container d-none">
                    ...
                    <div class="row" style="height: 100%;">
                        ...
                        <div class="col-lg-4 col-md-5" style="padding: 0; margin: 0; height: 100%;">
                            <div class="row" style="width: 100%; height: 100%;">
                                ...
                                <div class="col-md-6" style="background-color: #71BA71">
                                    <div style="margin-top: 40px;">
                                        <div class="row" style="text-align:center; margin: auto; margin-top: -20px;">
                                            <div class="col-md-12 my-auto">
                                                <img src="../img/Homepage/header-vpe-login (1).png" alt="VPE Access" class="img-responsive d-none" style="max-width:110px;">
												<img src="../img/AccessImage2.png" alt="VPE Access" class="img-responsive d-none" style="max-width:110px;">
												<img src="../img/access-logo4.png" alt="VPE Access" class="img-responsive d-none" style="max-width:150px;">
												<img src="../img/wpeaccess2.png" alt="VPE Access" class="img-responsive" style="max-width:150px;">
                                            </div>
                                            <div class="col-md-12">
                                                <a href="https://vp-access.com/" target="_blank" class="btn btn-light-green homepage-login-btn" style="background-color: #387D3D">
                                                    LOG IN
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="d-none d-xs-none d-sm-none d-md-none d-lg-block d-xl-block col-sm-12 col-md-12 col-lg-12 my-auto" style="background-color: white; margin:0; padding:0;">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="social-icons-div" style="float:right; margin-right: 30px;">
                        <div class="social-icons">
							<a href="https://www.facebook.com/valleyplainsequipment" target="_blank" class="social-media-icon-link">
                                <img src="../img/Homepage/Facebook.png" alt="Facebook">
							</a>
