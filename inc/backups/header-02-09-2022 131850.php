...
<body>
    ...
    <div id="main" class="container" style="background-color:white; padding-left:0; padding-right:0;">
        <?php
                    ...
                    <nav class="navbar navbar-expand-lg" style="padding: 0rem 1.25rem;">
                        <div class="collapse navbar-collapse desktop">{nav}main{/nav}
                            ...
                            <div class="cart-dropdown dropdown">
                                <button type="button" class="btn btn-default cart-button" data-toggle="dropdown">
                                    <i class="fa fa-shopping-cart" aria-hidden="true"></i> Cart <span class="cartcount badge badge-pill badge-dark">0</span>
                                </button>
