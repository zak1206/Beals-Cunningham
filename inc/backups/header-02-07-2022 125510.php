			...
			<div class="row text-white my-auto" style="background-color: #367C2B;">
				<div class="col-md-12 my-auto">
					<div class="green-nav-container d-flex justify-content-end my-auto">
                      <i class="fas fa-phone-alt" style="font-size: 20px; margin-top: 4px;"></i> <p class="proxima-nova light" style="margin-top: 4px; font-size: 16px;"><i> 1-800-635-8945</i></p>
                      <i class="fas fa-envelope" style="margin-left: 20px; font-size: 20px; margin-top: 4px;"></i> <p class="proxima-nova light" style="margin-top: 4px; font-size: 16px;"><i> Info@StellarEquipment.com</i></p>
                      <i class="fas fa-map-marker-alt" style="margin-left: 20px; font-size: 20px; margin-top: 4px;"></i> <p class="proxima-nova light" style="margin-top: 4px; font-size: 16px;"><i> Find a Store</i></p>
                      <a href="facebook.com" style="margin-left: 20px;"><i class="fab fa-facebook-f" style="font-size: 26px;"></i></a>
                      <a href="instagram.com" style="margin-left: 6px;"><i class="fab fa-instagram" style="font-size: 26px;"></i></a>
                      <a href="twitter.com" style="margin-left: 6px;"><i class="fab fa-twitter" style="font-size: 26px;"></i></a>
                      <a href="youtube.com" style="margin-left: 6px; margin-right: 5%;"><i class="fab fa-youtube" style="font-size: 26px;"></i></a>
                    </div>
				</div>
			</div>
            <div class="row main-nav">                       
            	<div class="col-md-2 my-auto">
                    <a class="navbar-brand" href="home">
                        <img src="img/Stellar-Logo-White.png" alt="Stellar Equipment Logo" width="225px"/>
                    </a>
                </div>
                <div class="col-md-10 justify-content-end d-flex" style="color: white;">
                	<nav class="navbar navbar-expand-lg" style="padding: 0rem 1.25rem;">
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">close</button>
