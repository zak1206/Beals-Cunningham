...
<div class="container-fluid" id="footer" style="background-color: #D2D3D4;">
  <div class="row">
    <div class="col-md-6" align="center">
      <img class="img-responsive" src="/plesk-site-preview/legacyequipment.com/https/72.47.192.199/img/footer-map.png" alt="legacy locations map" style="width: 300px;">
    </div>
    <div class="col-md-6">
      <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
          <ul class="footer-link-list"><a href="new-equipment">Equipment</a>
            <li><a href="new-equipment">New John Deere Equipment</a></li>
