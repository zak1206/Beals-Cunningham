...
<head>
    <meta charset="utf-8">
    <link rel="icon" href="../img/LegacyTabIconImg.png" type="image/gif" sizes="16x16">
    <?php
...
<![endif]-->
    ...
    <div class="container-fluid p-0 navigation-container">
        <div class="row no-gutter">
            ...
            <div class="col-md-9 col-lg-9 toggle-desktop" align="right" style="padding:0;">
                <div class="row" style="height: 100%;">
                    <div class="col-md-3"></div>
                    <div class="col-md-6 my-auto">
                        <div class="search-container">
                            <label style="margin-right: 8px; font-size: 14px; font-weight: 200;">FIND YOUR VALLEY PLAINS LOCATION</label>
                            ...
                            <button data-toggle="modal" data-target="#exampleModalzip" class="btn btn-blue" type="submit" onclick="getMylatlong()" style="color: white; background-color: #71ba71; padding-top: 6px; padding-bottom: 6px; border-top-left-radius: 0px; border-bottom-left-radius: 0px;"><span style="font-size: 12px;">SUBMIT</span></button>
                    ...
                    <div class="col-md-3" style="padding: 0; margin: 0; height: 100%;">
                        <div class="row" style="width: 100%; height: 100%;">
                            <div class="col-md-6" style="padding:0;">
                                <img src="../img/Homepage/footer-map.png" class="img-responsive" alt="Valley Plains Locations" style="height: 100%;">
                            </div>
                            <div class="col-md-6" style="background-color: #387D3C">
                                <div style="margin-top: 10px;">
                                    <div class="row" style="text-align:center; margin: auto;">
                                        <div class="col-md-12">
                                            <img src="../img/Homepage/header-vpe-login (1).png" alt="VPE Access" class="img-responsive">
                                        </div>
                                        <div class="col-md-12">
                                            <a href="#" class="btn btn-light-green">
                                                LOG IN
                                            </a>
                                        </div>
                                    </div>
        ...
        <div class="d-none d-xs-none d-sm-none d-md-none d-lg-block d-xl-block col-sm-12 col-md-12 col-lg-12 my-auto" style="background-color: white; margin:0; padding:0;">
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="social-icons-div" style="float:right; margin-right: 20px;">
                    <div class="social-icons"><a href="" class="social-media-icon-link">
