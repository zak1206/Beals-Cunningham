...
<label>Your Review</label><br>
            ...
            $html .= '<div class="col-md-8" style="padding:0"><img style=" display:block; margin:0px auto; width: 30%;" src="img/Custom/' . $image . '"></div>';
...
//            }
            ...
            if ($obj["price"] != null) {
                $html .= "Pricing <br><strong style=\"font-size: 24px\">$" . $obj["price"] . '</strong><br><br>';
                $html .= "Discount <br><strong style=\"font-size: 24px\">" . $obj["discount"] . '%</strong><br><br>';
            } else {
                $html .= '';
            }
//
...
//                $ifcart = '<button class="btn btn-dark save-later" data-eqid="'.$obj["id"].'" data-eqname="'.$obj["title"].'" data-eqtype="custom" data-price="'.$obj["msrp"].'" data-url="'.$actual_link.'"> Add To Cart <i class="fa fa-shopping-cart"></i></button>';
//            } elseif($theprice != '') {
...
//            }
            ...
            $html .= '<div class="clearfix"></div>'.$pricepresent.'<br><button class="btn btn-success parts-button moreinfo" style="background-color:#383838; border-color: #383838;" data-url="'.$actual_link.'" data-equipment="Custom - '.$title.'" data-toggle="modal" data-target="#exampleModal">Request A Quote</button> ' . $saveButton . '<br><br>'.$ifcart.'<br><br>
<!-- AddToAny BEGIN 
            ...
            <div class="card" style="margin-bottom: 20px; border-radius: 0px; border: transparent;">
                ...
                <div class="social">
                    ...
                    <small style="padding: 3px; display: block; background: #fff; color: #333; height: auto">'.$d["page_desc"].'<br><br></small>
                            ...
                            $catOut .= '<div align="center" class="col-md-4 col-sm-5' . $f["id"] . '" data-boxval="' . $f["id"] . '" >
    <div class="card" style="width: 240px; margin-bottom: 20px; border: 1px solid lightgrey; box-shadow:0 0px 8px rgba(0, 0, 0, 0.25); -moz-box-shadow:0 0px 8px rgba(0, 0, 0, 0.25); -webkit-box-shadow:0 0px 8px rgba(0, 0, 0, 0.25);">
        <div class="product-image6" align="center" style="margin-bottom: -80px; margin-top: -40px;">
            <a href="' . $_SERVER['REQUEST_URI'] . '/' . $f["title"] . '">
                <img class="pic-1 img-responsive fadeIn" style="padding: 65px;" src="../img/Custom/' . $mainImage . '">
        ...
        <div class="card-body" align="center">
                                <h4 class="card-title" style="color: #008001; font-weight: bold;">' . $f["title"] . '</h4>
                                <p class="card-text">' . $f["features"] . '</p>
                                <p class="card-text" style="margin-top: -10px;"><i>$' . $f["price"] . '</i></p>
                                <button class="btn save-later" style="background-color: #008001; color: white;" data-eqid="'.$f["id"].'" data-eqname="'.$f["title"].'" data-eqtype="custom" data-price="'.$f["price"].'" data-url="'.$actual_link.'"> Add To Cart <i class="fa fa-shopping-cart"></i></button><br/><br/>
                                <br/>
                                <p class="card-text" style="font-weight: bold; margin-top: -20px;">See Discount in the Cart</p>
                            </div>
