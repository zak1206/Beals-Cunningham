...
<div id="buildertop"></div><div class="container-fluid"> 
                    ...
                    <h3 style="display: none;">Build Your Own</h3> 
                    ...
                    <button type="button" class="step-trigger" role="tab" id="stepper1trigger1" aria-controls="test-l-1" onclick="location.reload()"> <span class="bs-stepper-circle">1</span> <span class="bs-stepper-label"></span> Select Equipment </button>
                     ...
                     <span class="bs-stepper-label proxima-nova">Implements</span> </button> </div> <div class="bs-stepper-line"></div> <div class="step" data-target="#test-l-3"> 
                     ...
                     <span class="bs-stepper-label proxima-nova">Accessories</span> </button> </div> <div class="bs-stepper-line"></div> <div class="step" data-target="#test-l-4"> 
                     ...
                     <span class="bs-stepper-label proxima-nova">Payments</span> </button> </div> </div> <div class="bs-stepper-content"> 
        ...
        $html .= '<div id="accordion proxinam-nova">';
            $html .= '<div class="card" style="border: none;">';
                $html .= '<div class="card-header" id="headingOne" style="background-color: #D3D3D3;">';
                    $html .= '<h1 class="proxima-nova-condensed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><i class="fa fa-angle-right" aria-hidden="true" style="font-size: 42px; font-weight: bold; color: #367C2B;"></i><i><b>Select Equipment Type</b></i></h1>';
                $html .= '</div>';
                $html .= '<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">';
                    $html .= '<div class="card-body">';
                        ...
                        while ($b = $a->fetch_array()) {
                            $html .= '<div class="col-md-4 col-lg-4 col-sm-12 builder-container" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" data-id="' . $b["package_name"] . '"><div class="card" style="border: none;">';
                            $html .= '<img src="' . $b["package_image"] . '" class="img-responsive show shadow" id="builder-eq" style="border-radiusL 20px 0px 0px 0px"/>';
                            $html .= '<div class="card-body" align="center"><h2 class="proxima-nova-condensed heavy italic">' . $b["package_name"] . '</h2></div>';
                            $html .= '</div></div>';
                        }
                        $html .= '</div>';
                    $html .= '</div>';
        ...
        /*$html .= '<div class="build-container"><div class="row"><div class="col-md-12"><h1>Select Equipment <i class="fas fa-caret-down ml-auto mr-auto" align="center" style="font-size: 42px; color: #367C2B;"></i></h1></div></div><div class="row">';
        while ($b = $a->fetch_array()) {
            $html .= '<div class="col-md-4 col-lg-4 col-sm-12 builder-container"  data-toggle="collapse" data-target="#builder-eq" data-id="' . $b["package_name"] . '"><div class="card">';
            $html .= '<img src="' . $b["package_image"] . '" class="img-responsive show" id="builder-eq"/>';
