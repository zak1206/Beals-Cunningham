...
//    echo '</pre>';
    ...
    for ($i = 0; $i < count($decoder); $i++) {
        ...
        if ($passid == $id) {
            $obj[] = '<strong>'.$decoder[$i]["Name"].'</strong><br><a class="remove-col" style="font-weight: 300" data-value="'.$decoder[$i]["ID"].'">Select a Different Model <span class="x"><i class="far fa-times-circle"></i></span></a>';
