...
if ($act == 'getcats') {
    ...
    $html .= '<select name="subcategory" id="subcat-select" class="form-control" onchange="getCategory(this); recallCaffTrak();" required>';
...
if ($act == 'getequip') {
    ...
    $html .= '<div class="clearfix"></div><button id="config" type="button" data-cafftrak="Build My Package" class="btn btn-success" style="margin-top: 50px;" onclick="startConfig();" >Build My Package</button>';
