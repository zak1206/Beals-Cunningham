                ...
                <div class="product-content" style="padding: 20px">
                    ...
                    <small style="padding: 3px; min-height: 150px; display: block">'.$d["page_desc"].'</small>
                            ...
                            if ($equip_content[$i]["type"] == 'htmlarea') {
                                ...
                                $e = $data->query("SELECT title, eq_image, id, price FROM stihl_equipment WHERE title = '" . $equip_content[$i]["title"] . "'")or die($data->error);
                                $f = $e->fetch_array();
            ...
            <div class="card" style="border: transparent;">
                <div class="product-image">
                    <a href="' . $_SERVER['REQUEST_URI'] . '/' . $f["title"] . '">
                        <img class="pic-1 img-responsive fadeIn" src="../img/Stihl/' . $equipImg . '">
                ...
                <div class="product-content" style="border: transparent;">
                    <h3 class="title" style="margin-bottom: 0; background: #FF7900; color: white; font-size: 20px;"><a style="color: white; padding-left: 20px;"href="' . $_SERVER['REQUEST_URI'] . '/' . $f["title"] . '">' . str_replace('-', ' ',$f["title"]) . '</a></h3>
