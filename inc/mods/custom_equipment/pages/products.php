...
$rev = $data->query("SELECT * FROM custom_equipment_reviews WHERE active = 'true'") or die($data->error);
            ...
            $reviewsOut .= '<article class="row g-0 py-3 mx-0 bcss_ecommerce_comment_list" data-rating="4" itemprop="review" itemscope="" itemtype="https://schema.org/Review">
                                        <section class="col-md-3">
                                            <ul class="bcss_ecommerce">
                                                ...
                                                <li><strong itemscope="" itemprop="author" itemtype="http://schema.org/Person">by <span class="bcss_ecommerce_light" itemprop="name">' . $review['by'] . '</span></strong></li>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row justify-content-center align-items-center">
                                    ...
                                    <div class="col-12 product-slide">
                                        <img class="img-fluid mx-auto d-block" src="' . $image . '" itemprop="image">
                                    </div>
...
for ($z = 0; $z < count($imageMain); $z++) {
    $html .= '<div class="col-3"><img class="img-thumbnail w-100" src="' . $imageMain[$z] . '" itemprop="image"></div>';
}
$html .= '</div>
...
$actual_link = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
$uniqIDs = md5(date('djsi'));
$html .= '<div class="col-md-6"><form method="POST" action="http://localhost:8888/stellar/inc/mods/custom_equipment/command_processor.php?action=addtocart">
...
$html .= '<a onclick="AddToCart"><button class="btn btn-dark add-to-cart disabs" style="border-radius:0;">Add To Cart</button></a>';
$html .= '</form></div>
<div class="col-md-6 ml-2"><h4>Testing</h4></div>
                    </div>
                    ...
                    <div class="col-12 col-lg-10 col-xl-12 mx-auto">
                        <div class="row other_product_slide slick-initialized slick-slider slick-dotted">
                            <button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="display: block;">Previous</button>
                            <div class="slick-list draggable">
                                <div class="slick-track" style="opacity: 1; width: 5004px; transform: translate3d(-1112px, 0px, 0px);">
                                    <div class="card col text-center slick-slide slick-cloned bcss_ecommerce_card" data-rating="2.5" data-slick-index="-4" aria-hidden="true" tabindex="-1" itemprop="isRelatedTo" itemscope itemtype="http://schema.org/Product">
                                        <div class="product-image6">
                                            <a href="/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/CRT428-82Volt-42-CrossoverT-Tractor-MultiBattery-6inParallel-Kitted-NEW-2022/WLG302-48V24V-DualVolt-LED-Flashlight-Tool-Only" tabindex="-1">
                                                <img class="pic-1 img-responsive fadeIn bcss_ecommerce_img" src="../../img/custom/3500502_wlg302-360-4_land.jpg" itemprop="image">
                                            </a>
                                        </div>
                                        <div class="product-content" style="padding: 20px;">
                                            <h4 class="title text-center bcss_ecommerce">
                                                <a class="bcss_ecommerce" href="/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/WLG302-48V24V-DualVolt-LED-Flashlight-Tool-Only" style="font-family:Bebas Neue, cursive; font-size:1.4rem;" tabindex="-1" itemprop="name">WLG302 48V24V DualVolt LED Flashlight Tool Only</a>
                                            </h4>
                                            <div class="d-flex flex-row justify-content-center align-items-center mt-2">
                                                ...
                                                <strong class="font-weight-normal" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating"><span itemprop="ratingValue">2.5</span>/5 (<span itemprop="reviewCount">1</span>)</strong>
                                            </div>
                                            <!--discounted prize-->
                                            <div class="mt-3" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                                <meta itemprop="url" href="https://www.example.com/trinket_offer" />
                                                <h4 class="d-block my-0 bcss_ecommerce_promotion-price">BLACK FRIDAY DEAL</h4>
                                                <meta itemprop="priceCurrency" content="USD" />
                                                <h4 class="my-0 bcss_ecommerce">$<span itemprop="price">3,699.00</span></h4>
                                                <strong class="d-inline-block bcss_ecommerce_promotion-difference">Save $1,300.00</strong>
                                                <strong class="d-inline-block bcss_ecommerce_promotion-old"> Was $4,999.00</strong>
                                                <meta itemprop="itemCondition" content="https://schema.org/NewCondition" />
                                            </div>
                                            <!--end discounted prize-->

                                            <!--regular prize-->
                                            <div class="mt-3 d-none" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                                <meta itemprop="url" href="https://www.example.com/trinket_offer" />
                                                <meta itemprop="priceCurrency" content="USD" />
                                                <h4 class="my-0 bcss_ecommerce">$<span itemprop="price">699.00</span></h4>
                                                <meta itemprop="itemCondition" content="https://schema.org/NewCondition" />
                                            </div>
                                            <!--end regular prize-->
                                            ...
                                            <!-- add to cart-->
                                            <div class="mt-2">
                                                <button class="btn btn-dark save-later disabs bcss_ecommerce_button" data-eqid="39" data-eqname="CRT428-82Volt-42-CrossoverT-Tractor-MultiBattery-6inParallel-Kitted-NEW-2022" data-eqtype="custom" data-price="3699.00" data-url="https://www.jamesriverequipment.com/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/CRT428-82Volt-42-CrossoverT-Tractor-MultiBattery-6inParallel-Kitted-NEW-2022" data-tabs="custom_equipment" data-pickup="True" data-itemid="57887e68e2ac096a24ed084f378594b4">Add them All</button>
                                            </div>
                                            <!-- end add to cart-->
                                        </div>
                                    </div>
                                    <div class="card col text-center slick-slide slick-cloned bcss_ecommerce_card" data-rating="5" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                        <div class="product-image6">
                                            <a href="/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/CRT428-82Volt-42-CrossoverT-Tractor-MultiBattery-6inParallel-Kitted-NEW-2022/WLG302-48V24V-DualVolt-LED-Flashlight-Tool-Only" tabindex="-1">
                                                <img class="pic-1 img-responsive fadeIn bcss_ecommerce_img" src="../../img/custom/3500502_wlg302-360-4_land.jpg">
                                            </a>
                                        </div>
                                        <div class="product-content" style="padding: 20px;">
                                            <h4 class="title text-center bcss_ecommerce">
                                                <a class="bcss_ecommerce" href="/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/WLG302-48V24V-DualVolt-LED-Flashlight-Tool-Only" style="font-family:Bebas Neue, cursive; font-size:1.4rem;" tabindex="-1">WLG302 48V24V DualVolt LED Flashlight Tool Only</a>
                                            </h4>
                                            <div class="d-flex flex-row justify-content-center align-items-center mt-2">
                                                <div class="ratings bcss_ecommerce d-flex flex-row mx-1">
                                                    <i class="bi bi-star-fill"></i>
                                                ...
                                                <strong class="font-weight-normal">1.0/5 (1)</strong>
                                            </div>
                                            <!--discounted prize-->
                                            <div class="mt-2">
                                                <h4 class="d-block my-0 bcss_ecommerce_promotion-price">BLACK FRIDAY DEAL</h4>
                                                <h4 class="my-0 bcss_ecommerce">$3,699.00</h4>
                                                <strong class="d-inline-block bcss_ecommerce_promotion-difference">Save $1,300.00</strong>
                                                <strong class="d-inline-block bcss_ecommerce_promotion-old"> Was $4,999.00</strong>
                                            </div>
                                            <!--end discounted prize-->
                                            ...
                                            <!--regular prize-->
                                            <h4 class="mt-2 d-none bcss_ecommerce">$349.99</h4>
                                            <!--end regular prize-->
                                    ...
                                    <div class="card col text-center slick-slide slick-cloned bcss_ecommerce_card" data-rating="3" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                        <div class="product-image6">
                                            <a href="/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/CRT428-82Volt-42-CrossoverT-Tractor-MultiBattery-6inParallel-Kitted-NEW-2022/WLG302-48V24V-DualVolt-LED-Flashlight-Tool-Only" tabindex="-1">
                                                <img class="pic-1 img-responsive fadeIn bcss_ecommerce_img" src="../../img/custom/3500502_wlg302-360-4_land.jpg">
                                            </a>
                                    ...
                                    <div class="card col text-center slick-slide slick-cloned bcss_ecommerce_card" data-rating="4.5" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                        <div class="product-image6">
                                            <a href="/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/CRT428-82Volt-42-CrossoverT-Tractor-MultiBattery-6inParallel-Kitted-NEW-2022/WLG302-48V24V-DualVolt-LED-Flashlight-Tool-Only" tabindex="-1">
                                                <img class="pic-1 img-responsive fadeIn bcss_ecommerce_img" src="../../img/custom/3500502_wlg302-360-4_land.jpg">
                                            </a>
                                    ...
                                    <div class="card col text-center slick-slide slick-cloned bcss_ecommerce_card" data-rating="4" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                        <div class="product-image6">
                                            <a href="/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/CRT428-82Volt-42-CrossoverT-Tractor-MultiBattery-6inParallel-Kitted-NEW-2022/WLG302-48V24V-DualVolt-LED-Flashlight-Tool-Only" tabindex="-1">
                                                <img class="pic-1 img-responsive fadeIn bcss_ecommerce_img" src="../../img/custom/3500502_wlg302-360-4_land.jpg">
                                            </a>
                                    ...
                                    <div class="card col text-center slick-slide slick-cloned bcss_ecommerce_card" data-rating="3.5" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                        <div class="product-image6">
                                            <a href="/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/CRT428-82Volt-42-CrossoverT-Tractor-MultiBattery-6inParallel-Kitted-NEW-2022/WLG302-48V24V-DualVolt-LED-Flashlight-Tool-Only" tabindex="-1">
                                                <img class="pic-1 img-responsive fadeIn bcss_ecommerce_img" src="../../img/custom/3500502_wlg302-360-4_land.jpg">
                                            </a>
                                    ...
                                    <div class="card col text-center slick-slide slick-cloned bcss_ecommerce_card" data-rating="2.5" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                        <div class="product-image6">
                                            <a href="/Greenworks-Battery-operated-equipment/greenworks-residential-mowers/CRT428-82Volt-42-CrossoverT-Tractor-MultiBattery-6inParallel-Kitted-NEW-2022/WLG302-48V24V-DualVolt-LED-Flashlight-Tool-Only" tabindex="-1">
                                                <img class="pic-1 img-responsive fadeIn bcss_ecommerce_img" src="../../img/custom/3500502_wlg302-360-4_land.jpg">
                                            </a>
                            ...
                            <ul class="slick-dots" style="display: block;" role="tablist">
                                ...
                                <li role="presentation">
                                    <button type="button" role="tab" id="slick-slide-control06" aria-controls="slick-slide06" aria-label="7 of 2" tabindex="-1">7</button>
                                </li>
                            </ul>
                        </div>
                    </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
            <div class="row">
                ...
                <div class="form-group">
                    <label for="length_of_ownership">Length of Ownership</label>
                    <select class="form-control" id="length_of_ownership" name="length_of_ownership">
      ...
      <div class="modal-footer">
            <button type="submit" class="btn btn-primary submit-review" name="submit" data-dismiss="modal">Submit</button>
            </form>
      </div>
    </div>
  </div>
